				...
				<div class="info-contact">
					<div class="row">
						<div class="col-md-6">
							<div class="left">
								<div class="place">
									<p><i class="fa fa-map-marker"></i>{{ isset($setting->site_address) ? $setting->site_address : ''}}</p>
									<p style="color: #e81919"><i class="fa fa-phone"></i>{{ isset($setting->site_phone) ? $setting->site_phone : '' }}</p>
								...
								<div class="form-sent">
									...
									<form action="{{ route('contact.store') }}" method='POST' autocomplete="off">
										...
										<div class="list-item-form">
											...
											<div class="item">
												<textarea name="content" placeholder="Nội dung" id="" cols="30" rows="10"></textarea>
											</div>
											<div class="item">

               ...
               <div class="navbar-custom-menu">
                  <ul class="nav navbar-nav">
                     ...
                     <li class="user user-menu">
                        ...
                        @else
                        <img src="{{ asset('uploads/user/no-image.png') }}" class="user-image" alt="User Image">
                        @endif
                        {!! $user->name !!}
                        </a>
                     </li>
...
{{--                     Thông báo--}}
         ...
         <footer class="main-footer">
            <strong>Copyright &copy; 2-2019 <a href="mailto:nvtrong393@gmail.com">nvtrong393s@gmail.com</a> </strong>
            All rights reserved.
         </footer>
      </div>
